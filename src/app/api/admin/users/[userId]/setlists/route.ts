...
// GET - Fetch setlists for a specific user (admin only)
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${API_URL}/api/admin/users/${userId}/setlists`, {
      headers: { Authorization: authHeader! },
    });
...
// POST - Create a setlist for a specific user (admin only)
